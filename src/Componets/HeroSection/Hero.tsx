  ...
  return (
    <div className="relative bg-black/90 min-h-screen flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 w-full text-white text-start py-8 px-4">
        ...
        <div className="container mx-auto w-full  flex flex-col gap-2 px-4">
          <div className="bg-[rgb(38,38,38)] rounded-md">
            <FAQDropdown
      ...
      <div className="relative z-10 w-full text-white text-start py-8 px-4 bg-black/80 flex flex-col">
        ...
        <p className="text-xs">
          This website is not affiliated with Netflix, Inc.
        </p>
      </div>
